...
export interface ApiQuizQuiz extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    phase: Schema.Attribute.Enumeration<
      ['Understanding', 'Developing', 'Performing', 'Leading']
    >;
    publishedAt: Schema.Attribute.DateTime;
    quizeType: Schema.Attribute.Enumeration<
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userAnswers: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiUserAnswerUserAnswer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    userAnswer: Schema.Attribute.JSON;
  };
}
...
export interface ApiUserProgressUserProgress
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Developing: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    DevelopingAnswerCount: Schema.Attribute.Integer;
    DevelopingScore: Schema.Attribute.Integer;
    Leading: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    LeadingAnswerCount: Schema.Attribute.Integer;
    LeadingScore: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    Performing: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    PerformingAnswerCount: Schema.Attribute.Integer;
    PerformingScore: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    Understanding: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    UnderstandingAnswerCount: Schema.Attribute.Integer;
    UnderstandingScore: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    user: Schema.Attribute.Relation<
